...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: 'A Developed a web app using Flask, Excel, and Pandas to track and analyze tasks.',
    ...
    {
      title: 'Comming soon',
      description: 'playing around with AI',
      image: 'https://images.unsplash.com/photo-1504608524841-42fe6f032b4b?w=500&h=300&fit=crop',
      technologies: ['Chatgpt', "Gemini","Claude" ],
      liveUrl: '#',
      githubUrl: '#',
    },
  ];
