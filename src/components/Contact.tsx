        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <h3 className="text-2xl font-semibold text-gray-900 mb-6 flex items-center gap-2">
              <ContactIcon className="text-blue-600" size={24} />
              Send Message
            </h3>
            ...
            <div className="space-y-4">
              {contactInfo.map((info, index) => (
                <a
                  key={info.label}
                  href={info.href}
                  className="flex items-center gap-4 p-4 bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-200 hover-scale"
                ...
                >
                  ...
                  <Link className="ml-auto text-blue-600" size={16} />
                </a>
              ))}
            </div>
          </div>
